<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=2F81F7&center=true&vCenter=true&width=435&lines=Hola!;+Soy+un+estudiante+de+ingeniería+en+sistemas" alt="Typing SVG" />
</div>
...
- **Estudiante:** Ingeniería en Sistemas Computacionales (TECNM en Celaya).
- **Enfoque actual:** Ciencia de datos, inteligencia artificial y redes.
- **Aprendiendo:** Simulación de sistemas operativos y algoritmos de optimización.
- **Objetivo:** Dominar el análisis de datos masivos y el backend.
...
* **Simulador de SO:** Un sistema en Python para visualizar gestión de procesos y memoria.
* **Zero Bot:** Un asistente de IA experimental para mentoría (integración con Gemini API).
* **Investigación:** Principios de disponibilidad y escalabilidad en bases de datos.
